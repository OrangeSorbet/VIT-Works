...
int main() {
    ...
    while(1) {
        ...
        case 3:
            ...
            update_value_BT(t, index, new_value);
        ...
        case 4:
            ...
            int del_index;
            int total_nodes = count_nodes(t);
            if(scanf("%d", &del_index) != 1 || del_index < 0 || del_index >= total_nodes) {
                printf("Invalid input. Please enter an integer index 0-%d.\n", total_nodes - 1);
                while(getchar() != '\n');
                break;
            }
            delete_value_BT(&t, del_index);
